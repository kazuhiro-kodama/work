...
public class E62750 extends E62750Base {
  ...
  protected void openCr01() throws Exception {
    ...
    setCr01Opened("Y");
    /* BEGIN: MANUAL INJECTION */
    cr01 = status181Repository.findAllByOrderByPlntCdAscPlntCntrlNoAsc().iterator();
    if (cr01 != null) {
      setSqlcode(0);
    } else {
      setSqlcode(-1);
  ...
  protected void fetchCr01() throws Exception {
    ...
    if (cr01.hasNext()) {
      ...
      setHKoujouKubun181(status181.getPlntCd());
      setHKoujouControlNo181(status181.getPlntCntrlNo());
      setHModel181(status181.getEndItmCd());
      setHColor181(status181.getExtrrClrCd());
      setHUchibari181(status181.getIntrrClrCd());
      setHExNo181(status181.getExNo());
      setHShimukechi181(status181.getDstntnCd());
      setHLineMain181(status181.getBdyMainLineClss());
      setHLineMetal181(status181.getMtlLineClss());
      setHLinePaint181(status181.getPntLineClss());
      setHLineTrim181(status181.getTrmLineClss());
      setHKokuyuKubun181(status181.getDmstcExprtClss());
      setHKijunShakei181(status181.getStndrdCarSrsCd());
      setHDakokuKatashiki181(status181.getStmpngMdlCd());
      setHChassisNo181(status181.getChassisNo());
      setHEngKatashiki181(status181.getEngnMdlCd());
      setHEngNo181(status181.getEngnNo());
      setHOrgModel181(status181.getOrgnlEndItmCd());
      setHOrgColor181(status181.getOrgnlExtrrClrCd());
      setHOrgUchibari181(status181.getOrgnlIntrrClrCd());
      setHOrgExNo181(status181.getOrgnlExNo());
      setHOrgLineKubun181(status181.getOrgnlLineClss());
      setHShakeiCode181(status181.getCarSrsCd());
      setHShameiCode181(status181.getVhclNmCd());
      setHOrderKubun181(status181.getDlrOrdrClss());
      setHDealerNo181(status181.getDlrCd());
      setHOrderNo181(status181.getOrdrNo());
      setHComfirmedOrderNo181(status181.getDlrOrdrNo());
      setHCustomerName181(status181.getCstmrNm());
      setHTenjiPryCode181(status181.getDsplyCd());
      setHStatusPoint181(status181.getSttsPntCd());
      setHJissekiJikoku01181(status181.getActlPrcssDtShftTm01().longValue());
      setHJissekiJikoku02181(status181.getActlPrcssDtShftTm02().longValue());
      setHJissekiJikoku03181(status181.getActlPrcssDtShftTm03().longValue());
      setHJissekiJikoku04181(status181.getActlPrcssDtShftTm04().longValue());
      setHJissekiJikoku05181(status181.getActlPrcssDtShftTm05().longValue());
      setHJissekiJikoku06181(status181.getActlPrcssDtShftTm06().longValue());
      setHJissekiJikoku07181(status181.getActlPrcssDtShftTm07().longValue());
      setHJissekiJikoku08181(status181.getActlPrcssDtShftTm08().longValue());
      setHJissekiJikoku09181(status181.getActlPrcssDtShftTm09().longValue());
      setHJissekiJikoku10181(status181.getActlPrcssDtShftTm10().longValue());
      setHJissekiJikoku11181(status181.getActlPrcssDtShftTm11().longValue());
      setHJissekiJikoku12181(status181.getActlPrcssDtShftTm12().longValue());
      setHJissekiJikoku13181(status181.getActlPrcssDtShftTm13().longValue());
      setHJissekiJikoku14181(status181.getActlPrcssDtShftTm14().longValue());
      setHJissekiJikoku15181(status181.getActlPrcssDtShftTm15().longValue());
      setHJissekiJikoku16181(status181.getActlPrcssDtShftTm16().longValue());
      setHJissekiJikoku17181(status181.getActlPrcssDtShftTm17().longValue());
      setHOriginalKeikaku01181(status181.getOrgnlPlnPrcssDtShftTm01().longValue());
      setHOriginalKeikaku02181(status181.getOrgnlPlnPrcssDtShftTm02().longValue());
      setHOriginalKeikaku03181(status181.getOrgnlPlnPrcssDtShftTm03().longValue());
      setHOriginalKeikaku04181(status181.getOrgnlPlnPrcssDtShftTm04().longValue());
      setHOriginalKeikaku05181(status181.getOrgnlPlnPrcssDtShftTm05().longValue());
      setHOriginalKeikaku06181(status181.getOrgnlPlnPrcssDtShftTm06().longValue());
      setHOriginalKeikaku07181(status181.getOrgnlPlnPrcssDtShftTm07().longValue());
      setHOriginalKeikaku08181(status181.getOrgnlPlnPrcssDtShftTm08().longValue());
      setHOriginalKeikaku09181(status181.getOrgnlPlnPrcssDtShftTm09().longValue());
      setHOriginalKeikaku10181(status181.getOrgnlPlnPrcssDtShftTm10().longValue());
      setHOriginalKeikaku11181(status181.getOrgnlPlnPrcssDtShftTm11().longValue());
      setHOriginalKeikaku12181(status181.getOrgnlPlnPrcssDtShftTm12().longValue());
      setHOriginalKeikaku13181(status181.getOrgnlPlnPrcssDtShftTm13().longValue());
      setHOriginalKeikaku14181(status181.getOrgnlPlnPrcssDtShftTm14().longValue());
      setHOriginalKeikaku15181(status181.getOrgnlPlnPrcssDtShftTm15().longValue());
      setHOriginalKeikaku16181(status181.getOrgnlPlnPrcssDtShftTm16().longValue());
      setHOriginalKeikaku17181(status181.getOrgnlPlnPrcssDtShftTm17().longValue());
      setHRevised2Keikaku01181(status181.getRvsd2PlnPrcssDtShftTm01().longValue());
      setHRevised2Keikaku02181(status181.getRvsd2PlnPrcssDtShftTm02().longValue());
      setHRevised2Keikaku03181(status181.getRvsd2PlnPrcssDtShftTm03().longValue());
      setHRevised2Keikaku04181(status181.getRvsd2PlnPrcssDtShftTm04().longValue());
      setHRevised2Keikaku05181(status181.getRvsd2PlnPrcssDtShftTm05().longValue());
      setHRevised2Keikaku06181(status181.getRvsd2PlnPrcssDtShftTm06().longValue());
      setHRevised2Keikaku07181(status181.getRvsd2PlnPrcssDtShftTm07().longValue());
      setHRevised2Keikaku08181(status181.getRvsd2PlnPrcssDtShftTm08().longValue());
      setHRevised2Keikaku09181(status181.getRvsd2PlnPrcssDtShftTm09().longValue());
      setHRevised2Keikaku10181(status181.getRvsd2PlnPrcssDtShftTm10().longValue());
      setHRevised2Keikaku11181(status181.getRvsd2PlnPrcssDtShftTm11().longValue());
      setHRevised2Keikaku12181(status181.getRvsd2PlnPrcssDtShftTm12().longValue());
      setHRevised2Keikaku13181(status181.getRvsd2PlnPrcssDtShftTm13().longValue());
      setHRevised2Keikaku14181(status181.getRvsd2PlnPrcssDtShftTm14().longValue());
      setHRevised2Keikaku15181(status181.getRvsd2PlnPrcssDtShftTm15().longValue());
      setHRevised2Keikaku16181(status181.getRvsd2PlnPrcssDtShftTm16().longValue());
      setHRevised2Keikaku17181(status181.getRvsd2PlnPrcssDtShftTm17().longValue());
      setHRevised1Keikaku01181(status181.getRvsd1PlnPrcssDtShftTm01().longValue());
      setHRevised1Keikaku02181(status181.getRvsd1PlnPrcssDtShftTm02().longValue());
      setHRevised1Keikaku03181(status181.getRvsd1PlnPrcssDtShftTm03().longValue());
      setHRevised1Keikaku04181(status181.getRvsd1PlnPrcssDtShftTm04().longValue());
      setHRevised1Keikaku05181(status181.getRvsd1PlnPrcssDtShftTm05().longValue());
      setHRevised1Keikaku06181(status181.getRvsd1PlnPrcssDtShftTm06().longValue());
      setHRevised1Keikaku07181(status181.getRvsd1PlnPrcssDtShftTm07().longValue());
      setHRevised1Keikaku08181(status181.getRvsd1PlnPrcssDtShftTm08().longValue());
      setHRevised1Keikaku09181(status181.getRvsd1PlnPrcssDtShftTm09().longValue());
      setHRevised1Keikaku10181(status181.getRvsd1PlnPrcssDtShftTm10().longValue());
      setHRevised1Keikaku11181(status181.getRvsd1PlnPrcssDtShftTm11().longValue());
      setHRevised1Keikaku12181(status181.getRvsd1PlnPrcssDtShftTm12().longValue());
      setHRevised1Keikaku13181(status181.getRvsd1PlnPrcssDtShftTm13().longValue());
      setHRevised1Keikaku14181(status181.getRvsd1PlnPrcssDtShftTm14().longValue());
      setHRevised1Keikaku15181(status181.getRvsd1PlnPrcssDtShftTm15().longValue());
      setHRevised1Keikaku16181(status181.getRvsd1PlnPrcssDtShftTm16().longValue());
      setHRevised1Keikaku17181(status181.getRvsd1PlnPrcssDtShftTm17().longValue());
      setHIkkatsuSym201181(status181.getChngngSchdlFlg201());
      setHIkkatsuSym202181(status181.getChngngSchdlFlg202());
      setHIkkatsuSym203181(status181.getChngngSchdlFlg203());
      setHIkkatsuSym204181(status181.getChngngSchdlFlg204());
      setHIkkatsuSym205181(status181.getChngngSchdlFlg205());
      setHIkkatsuSym206181(status181.getChngngSchdlFlg206());
      setHIkkatsuSym207181(status181.getChngngSchdlFlg207());
      setHIkkatsuSym208181(status181.getChngngSchdlFlg208());
      setHIkkatsuSym209181(status181.getChngngSchdlFlg209());
      setHIkkatsuSym210181(status181.getChngngSchdlFlg210());
      setHIkkatsuSym211181(status181.getChngngSchdlFlg211());
      setHIkkatsuSym212181(status181.getChngngSchdlFlg212());
      setHIkkatsuSym213181(status181.getChngngSchdlFlg213());
      setHIkkatsuSym214181(status181.getChngngSchdlFlg214());
      setHIkkatsuSym215181(status181.getChngngSchdlFlg215());
      setHIkkatsuSym216181(status181.getChngngSchdlFlg216());
      setHIkkatsuSym217181(status181.getChngngSchdlFlg217());
      setHIkkatsuSym101181(status181.getChngngSchdlFlg101());
      setHIkkatsuSym102181(status181.getChngngSchdlFlg102());
      setHIkkatsuSym103181(status181.getChngngSchdlFlg103());
      setHIkkatsuSym104181(status181.getChngngSchdlFlg104());
      setHIkkatsuSym105181(status181.getChngngSchdlFlg105());
      setHIkkatsuSym106181(status181.getChngngSchdlFlg106());
      setHIkkatsuSym107181(status181.getChngngSchdlFlg107());
      setHIkkatsuSym108181(status181.getChngngSchdlFlg108());
      setHIkkatsuSym109181(status181.getChngngSchdlFlg109());
      setHIkkatsuSym110181(status181.getChngngSchdlFlg110());
      setHIkkatsuSym111181(status181.getChngngSchdlFlg111());
      setHIkkatsuSym112181(status181.getChngngSchdlFlg112());
      setHIkkatsuSym113181(status181.getChngngSchdlFlg113());
      setHIkkatsuSym114181(status181.getChngngSchdlFlg114());
      setHIkkatsuSym115181(status181.getChngngSchdlFlg115());
      setHIkkatsuSym116181(status181.getChngngSchdlFlg116());
      setHIkkatsuSym117181(status181.getChngngSchdlFlg117());
      setHYoteiInputJikoku01181(status181.getRprCmpltnPlnTm01().longValue());
      setHYoteiInputJikoku02181(status181.getRprCmpltnPlnTm02().longValue());
      setHYoteiInputJikoku03181(status181.getRprCmpltnPlnTm03().longValue());
      setHYoteiInputJikoku04181(status181.getRprCmpltnPlnTm04().longValue());
      setHYoteiInputJikoku05181(status181.getRprCmpltnPlnTm05().longValue());
      setHYoteiInputJikoku06181(status181.getRprCmpltnPlnTm06().longValue());
      setHYoteiInputJikoku07181(status181.getRprCmpltnPlnTm07().longValue());
      setHYoteiInputJikoku08181(status181.getRprCmpltnPlnTm08().longValue());
      setHYoteiInputJikoku09181(status181.getRprCmpltnPlnTm09().longValue());
      setHYoteiInputJikoku10181(status181.getRprCmpltnPlnTm10().longValue());
      setHYoteiInputJikoku11181(status181.getRprCmpltnPlnTm11().longValue());
      setHYoteiInputJikoku12181(status181.getRprCmpltnPlnTm12().longValue());
      setHYoteiInputJikoku13181(status181.getRprCmpltnPlnTm13().longValue());
      setHYoteiInputJikoku14181(status181.getRprCmpltnPlnTm14().longValue());
      setHYoteiInputJikoku15181(status181.getRprCmpltnPlnTm15().longValue());
      setHYoteiInputJikoku16181(status181.getRprCmpltnPlnTm16().longValue());
      setHYoteiInputJikoku17181(status181.getRprCmpltnPlnTm17().longValue());
      setHHanedashiRiyuu101181(status181.getLineOutRsnCd101());
      setHHanedashiRiyuu102181(status181.getLineOutRsnCd102());
      setHHanedashiRiyuu103181(status181.getLineOutRsnCd103());
      setHHanedashiRiyuu104181(status181.getLineOutRsnCd104());
      setHHanedashiRiyuu105181(status181.getLineOutRsnCd105());
      setHHanedashiRiyuu106181(status181.getLineOutRsnCd106());
      setHHanedashiRiyuu107181(status181.getLineOutRsnCd107());
      setHHanedashiRiyuu108181(status181.getLineOutRsnCd108());
      setHHanedashiRiyuu109181(status181.getLineOutRsnCd109());
      setHHanedashiRiyuu110181(status181.getLineOutRsnCd110());
      setHHanedashiRiyuu111181(status181.getLineOutRsnCd111());
      setHHanedashiRiyuu112181(status181.getLineOutRsnCd112());
      setHHanedashiRiyuu113181(status181.getLineOutRsnCd113());
      setHHanedashiRiyuu114181(status181.getLineOutRsnCd114());
      setHHanedashiRiyuu115181(status181.getLineOutRsnCd115());
      setHHanedashiRiyuu116181(status181.getLineOutRsnCd116());
      setHHanedashiRiyuu117181(status181.getLineOutRsnCd117());
      setHHanedashiRiyuu201181(status181.getLineOutRsnCd201());
      setHHanedashiRiyuu202181(status181.getLineOutRsnCd202());
      setHHanedashiRiyuu203181(status181.getLineOutRsnCd203());
      setHHanedashiRiyuu204181(status181.getLineOutRsnCd204());
      setHHanedashiRiyuu205181(status181.getLineOutRsnCd205());
      setHHanedashiRiyuu206181(status181.getLineOutRsnCd206());
      setHHanedashiRiyuu207181(status181.getLineOutRsnCd207());
      setHHanedashiRiyuu208181(status181.getLineOutRsnCd208());
      setHHanedashiRiyuu209181(status181.getLineOutRsnCd209());
      setHHanedashiRiyuu210181(status181.getLineOutRsnCd210());
      setHHanedashiRiyuu211181(status181.getLineOutRsnCd211());
      setHHanedashiRiyuu212181(status181.getLineOutRsnCd212());
      setHHanedashiRiyuu213181(status181.getLineOutRsnCd213());
      setHHanedashiRiyuu214181(status181.getLineOutRsnCd214());
      setHHanedashiRiyuu215181(status181.getLineOutRsnCd215());
      setHHanedashiRiyuu216181(status181.getLineOutRsnCd216());
      setHHanedashiRiyuu217181(status181.getLineOutRsnCd217());
      setHDeliveryLeadKotei181(status181.getDlvryFxngLdTmMnt().longValue());
      setHDeliveryLeadYoyuu181(status181.getDlvryMrgnLdTmMnt().longValue());
      setHIkansaki181(status181.getTrnsfrCd());
      setHKensaIkanShikibetsu181(status181.getInspctnTrnsfrFlg());
      setHKasoushaSym181(status181.getMntngVhclFlg());
      setHKasouMaker181(status181.getMntngVhclMkrCd());
      setHKasouKanryouLead181(status181.getMntngCmpltnLdTm().longValue());
      setHTokkiJikou181(status181.getSpclNtfctnClmn());
      setHActSchKey181(status181.getActlSchdlClss());
      setHActSeqNo181(status181.getOfflnSeqNo());
      setHShataiReActSeqNo181(status181.getSetupSeqNo());
      setHFinalReActSeqNo181(status181.getFnlOkSeqNo());
      setHTrimSeqNo181(status181.getTrimInId());
      setHOfflineSeqNo181(status181.getOfflnId());
      setHKankenYmd181(status181.getVhclFnshdActlDt());
      setHMsOfflineYmd181(status181.getMstrSchdlOfflnPlnDt());
      setHSymTokushusha181(status181.getSpclVhclFlg());
      setHSymKouteiKeikakuGai181(status181.getPrcssPlnExclddFlg());
      setHSymZaikoZumi181(status181.getStckUpdtdFlg());
      setHSymGyakubarashiGai181(status181.getBckFlshExclddFlg());
      setHSymSenkouMiGai181(status181.getOvrBltBckLogExclddFlg());
      setHSymSmDaihyou181(status181.getRsntvOvrBltBckLogFlg());
      setHSymSmKoutei01181(status181.getPrcssOvrBltBckLogFlg01());
      setHSymSmKoutei02181(status181.getPrcssOvrBltBckLogFlg02());
      setHSymSmKoutei03181(status181.getPrcssOvrBltBckLogFlg03());
      setHSymSmKoutei04181(status181.getPrcssOvrBltBckLogFlg04());
      setHSymSmKoutei05181(status181.getPrcssOvrBltBckLogFlg05());
      setHSymSmKoutei06181(status181.getPrcssOvrBltBckLogFlg06());
      setHSymSmKoutei07181(status181.getPrcssOvrBltBckLogFlg07());
      setHSymSmKoutei08181(status181.getPrcssOvrBltBckLogFlg08());
      setHSymSmKoutei09181(status181.getPrcssOvrBltBckLogFlg09());
      setHSymSmKoutei10181(status181.getPrcssOvrBltBckLogFlg10());
      setHSymSmKoutei11181(status181.getPrcssOvrBltBckLogFlg11());
      setHSymSmKoutei12181(status181.getPrcssOvrBltBckLogFlg12());
      setHSymSmKoutei13181(status181.getPrcssOvrBltBckLogFlg13());
      setHSymSmKoutei14181(status181.getPrcssOvrBltBckLogFlg14());
      setHSymSmKoutei15181(status181.getPrcssOvrBltBckLogFlg15());
      setHSymSmKoutei16181(status181.getPrcssOvrBltBckLogFlg16());
      setHSymSmKoutei17181(status181.getPrcssOvrBltBckLogFlg17());
      setHSymZengetsuJisseki01181(status181.getNmns1MnthRsltDltFlg01());
      setHSymZengetsuJisseki02181(status181.getNmns1MnthRsltDltFlg02());
      setHSymZengetsuJisseki03181(status181.getNmns1MnthRsltDltFlg03());
      setHSymZengetsuJisseki04181(status181.getNmns1MnthRsltDltFlg04());
      setHSymZengetsuJisseki05181(status181.getNmns1MnthRsltDltFlg05());
      setHSymZengetsuJisseki06181(status181.getNmns1MnthRsltDltFlg06());
      setHSymZengetsuJisseki07181(status181.getNmns1MnthRsltDltFlg07());
      setHSymZengetsuJisseki08181(status181.getNmns1MnthRsltDltFlg08());
      setHSymZengetsuJisseki09181(status181.getNmns1MnthRsltDltFlg09());
      setHSymZengetsuJisseki10181(status181.getNmns1MnthRsltDltFlg10());
      setHSymZengetsuJisseki11181(status181.getNmns1MnthRsltDltFlg11());
      setHSymZengetsuJisseki12181(status181.getNmns1MnthRsltDltFlg12());
      setHSymZengetsuJisseki13181(status181.getNmns1MnthRsltDltFlg13());
      setHSymZengetsuJisseki14181(status181.getNmns1MnthRsltDltFlg14());
      setHSymZengetsuJisseki15181(status181.getNmns1MnthRsltDltFlg15());
      setHSymZengetsuJisseki16181(status181.getNmns1MnthRsltDltFlg16());
      setHSymZengetsuJisseki17181(status181.getNmns1MnthRsltDltFlg17());
      setHSymTlMetal181(status181.getExpssVhclLblMtlOkFlg());
      setHSymTlShitaP181(status181.getExpssVhclLblUndrctOkFlg());
      setHSymTlNakaP181(status181.getExpssVhclLblIntmdtctOkFlg());
      setHSymTlPaint181(status181.getExpssVhclLblPntOkFlg());
      setHSymTlFinal181(status181.getExpssVhclLblFnlOkFlg());
      setHSymTlDeliv181(status181.getExpssVhclLblDlvryOkFlg());
      setHSymPipeLineGai181(status181.getPipeLineExclddFlg());
      setHSymPipeLineZumi181(status181.getPipeLineTrnsmttdFlg());
      setHSymKeikakuMitei181(status181.getUncnfrmdPlnFlg());
      setHSeisanHoushiki181(status181.getPrdctnMthdClss());
      setHSymShisakuSha181(status181.getTrlVhclFlg());
      setHSymGyakuYunyuu181(status181.getReImprtVhclFlg());
      setHHyoujiGenzaichi181(status181.getDsplyCrrntLctnCd());
      setHSalesSpec10181(status181.getDlvrySlsDtShftTm());
      setHLocalArea181(status181.getLclRmrkClmn());
      setHTimeStamp181(status181.getTmStmp());
      setHDelivEigyouHizuke181(status181.getDlvrySlsDt().longValue());
      setHSymHanedashi181(status181.getLineOutInptFlg());
      setHSeihinKubun181(status181.getPrdctClss());
  ...
  protected void fetchCr02() throws Exception {
    ...
    if (cr02.hasNext()) {
      ...
      setHKoujouKubun182(shiyou182.getPlntCd());
      setHModel182(shiyou182.getEndItmCd());
      setHColorUchibariEx182(shiyou182.getClrCdExNoClmn());
      setHLineTrim182(shiyou182.getTrmLineClss());
      setHKokuyuKubun182(shiyou182.getDmstcExprtClss());
      setHYymm182(shiyou182.getTrgtPrdtcnYm());
      setHKouteiId182(shiyou182.getSttsPntCd());
      setHJissekiZengetsu182(shiyou182.getActlNMns1MnthPrdctnQty().longValue());
      setHJissekiTougetsu182(shiyou182.getActlNMnthPrdctnQty());
      setHJissekiJigetsu182(shiyou182.getActlNPls1MnthPrdctnQty());
      setHRuisaZenZengetsu182(shiyou182.getNmns2MnthTtlVlncQty().longValue());
      setHKeikakuZengetsu182(shiyou182.getPlnNMns1MnthPrdctnQty().longValue());
      setHRuisaZengetsu182(shiyou182.getNmns1MnthTtlVlncQty().longValue());
      setHKeikakuTougetsu182(shiyou182.getPlnNMnthPrdctnQty());
      setHKeikakuJigetsu182(shiyou182.getPlnNPls1MnthPrdctnQty());
      setHIkanZengetsu182(shiyou182.getNmns1MnthIntrnlTrnsfrQty().longValue());
      setHIkanTougetsu182(shiyou182.getNmnthIntrnlTrnsfrQty().longValue());
      setHIkanJigetsu182(shiyou182.getNpls1MnthIntrnlTrnsfrQty().longValue());
      setHShikyuuZengetsu182(shiyou182.getNmns1MnthCnsgnQty().longValue());
      setHShikyuuTougetsu182(shiyou182.getNmnthCnsgnQty().longValue());
      setHShikyuuJigetsu182(shiyou182.getNpls1MnthCnsgnQty().longValue());
      setHMikenZenZengetsu182(shiyou182.getNmns2MnthBfrFokStckQty().longValue());
      setHMikenZengetsu182(shiyou182.getNmns1MnthBfrFokStckQty().longValue());
      setHKankenZenZengetsu182(shiyou182.getNmns2MnthFokStckQty().longValue());
      setHKankenZengetsu182(shiyou182.getNmns1MnthFokStckQty().longValue());
